...
void MCF2_lp::initialize_new_search_tree_node(const BCP_vec<BCP_var*>& vars,
...
BCP_solution*
MCF2_lp::test_feasibility(const BCP_lp_result& lpres,
...
double
MCF2_lp::compute_lower_bound(const double old_lower_bound,
...
void
MCF2_lp::generate_vars_in_lp(const BCP_lp_result& lpres,
			    const BCP_vec<BCP_var*>& vars,
			    const BCP_vec<BCP_cut*>& cuts,
...
void
MCF2_lp::vars_to_cols(const BCP_vec<BCP_cut*>& cuts,
...
MCF2_lp::select_branching_candidates(const BCP_lp_result& lpres,
				    const BCP_vec<BCP_var*>& vars,
				    const BCP_vec<BCP_cut*>& cuts,
...
void MCF2_lp::unpack_module_data(BCP_buffer& buf)
{
    par.unpack(buf);
    data.unpack(buf);
