...
LP: uneven new_cuts/new_rows sizes in generate_cuts_in_lp().\n");
   ...
   if (p.param(BCP_lp_par::MessagePassingIsSerial)) {
      ...
      // the CG/CP are working the LP stops and also the LP must immediately
      // process any cuts sent back then this is the place to send the lp
      // solution to the CG/CP.
